...
public class AnshApp {

    private static final Logger log = LoggerFactory.getLogger(AnshApp.class);

    private final Environment env;

    public AnshApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AnshApp.class);
